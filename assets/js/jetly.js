  ...
  if ($(".contact-form-validated").length) {
    $(".contact-form-validated").validate({
      ...
      submitHandler: function (form) {
        ...
        //loading ekrani gelecek form saklanacak
        $("#contact-form").hide();
        ...
        $.post(
          ...
          function (response) {
            ...
            if(response.mailcustomerresult == 'success'){
              ...
              $(form).parent().find(".result-success").append(response.mailcustomermessage);
             ...
             //error mesaj show olsun ve 15 saniye sonra kapansin (set time out)
             $(".result-error").show();
              setTimeout(function() { 
                $(".result-error").hide();
                $("#contact-form").show();
              ...
              $(form).parent().find(".result-error").append(response.mailcustomermessage);
